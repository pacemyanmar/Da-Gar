<div class="modal fade" id="upload-project" tabindex="-1" role="dialog" aria-labelledby="uploadLabel">
    {!! Form::open(['route' => ['projects.import'], 'method' => 'post', 'class' => 'upload', 'id' => 'uploadForm', 'files' => true]) !!}
    <div class="modal-dialog modal-lg" role="document">
        ...
        <span class="btn btn-primary btn-file" id="file">
            ...
            {!! Form::file('projectfile', ['aria-describedby' => 'file', 'id'=>'upload']); !!}
        </span>
                </div>
            </div>
