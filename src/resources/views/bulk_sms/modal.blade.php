...
@push('before-body-end')
    <div class="modal fade" id="upload-sms" tabindex="-1" role="dialog" aria-labelledby="uploadLabel">
        {!! Form::open(['route' => ['bulksms.import'], 'method' => 'post', 'class' => 'upload', 'id' => 'uploadForm', 'files' => true]) !!}
        ...
        <span class="btn btn-primary btn-file" id="file">
            ...
            {!! Form::file('smsfile', ['aria-describedby' => 'file', 'id'=>'upload']); !!}
        </span>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#upload-sms').on('shown.bs.modal', function (event) {
