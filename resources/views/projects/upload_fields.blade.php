...
<div>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#withFile" aria-controls="home" role="tab" data-toggle="tab">Upload
                File</a></li>
        <li role="presentation"><a href="#withUrl" aria-controls="profile" role="tab" data-toggle="tab">Paste file
                URL</a></li>
    </ul>
    <br>
    <!-- Tab panes -->
