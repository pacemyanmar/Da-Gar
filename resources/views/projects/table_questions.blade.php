                        ...
                        @if(Auth::user()->role->level >= 8)
                            <div class="btn-group form-inline" style="margin-bottom:20px;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="columns[question]" class="form-control"
                                           placeholder="{!! trans('messages.add_translation') !!}"
                                           @if(!empty($question->question_trans) )
                ...
                <td class="col-xs-2">
                    ...
                    <div class='btn-group'>
                        <button type="button" class="btn btn-info btn-xs" data-toggle="collapse"
                                data-target="#accordion{!! $question->css_id !!}">
                        ...
                        <a href="#" class='btn btn-default btn-xs'
                           ...
                           data-method='PATCH'><i class="glyphicon glyphicon-edit"></i> {!! trans('messages.edit') !!}
                        </a>
                            ...
                            <div class="btn-group form-inline" style="margin-bottom:20px;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="translation" class="form-control"
                                           ...
                                           value="{!! $question->question_trans !!}"
                                            @endif>
                                    <input type="hidden" name="origin" value="{!! $question->question !!}">
                                    <input type="hidden" name="key" value="{!! $question->id.$question->qnum !!}">
                                    <input type="hidden" name="group" value="questions">
                                    <span class="input-group-btn">
                                <button class="btn btn-default" type="submit">{!! trans('messages.save') !!}</button>
                              </span>
