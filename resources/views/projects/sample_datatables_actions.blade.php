...
<div class='btn-group'>
    <a href="{{ route('projects.surveys.create', [$project_id, $samples_id, $form_id, $sample_id]) }}" class='btn btn-default btn-md'>
        <i class="glyphicon glyphicon-edit"></i>
    </a>
    @if(Auth::user()->role->level > 9)
    <a href="{{ route('projects.surveys.show', [$project_id, $samples_id]) }}" class='btn btn-default btn-md'>
