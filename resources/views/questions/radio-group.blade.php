...
<table class="table table-responsive" >
	...
	<tr>
		...
		<td>{!! Form::radio($av['name'], $value['value'], null, ['id' => $value['id'],'class' => 'magic-radio magic-'.$av['name']]) !!}<label class="normal-text" for='{{ $value['id'] }}'><!-- dummy for magic radio --></label></td>
		@endforeach
		@else
		@php
		$layoutError = true;
